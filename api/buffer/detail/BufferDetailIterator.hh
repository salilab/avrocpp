...
class BufferIterator {
 ...
 public:
  ...
  //@{
  typedef std::forward_iterator_tag iterator_category;  // this is a lie to
                                                        // appease asio
  ...
  */
  ...
  /// Dereference iterator, returns InputIteratorHelper or OutputIteratorHelper
  /// wrapper.
  reference operator*() { return helper_; }

  /// Dereference iterator, returns const InputIteratorHelper or
  /// OutputIteratorHelper wrapper.
